...
pub trait PoolExt {
    fn is_in_settlement(&self, now: u64) -> bool;
    fn is_reduce_only(&self) -> bool;
    fn get_sanitize_clamp_denominator(&self) -> Option<i64>;
    fn get_insurance_coverage_multiplier(&self) -> u64;
    fn get_amount_out(
        &self,
        e: &Env,
        in_amount: u128,
...
impl PoolExt for Pool {
    fn is_in_settlement(&self, _now: u64) -> bool {
...
pub trait PoolTierExt {
    fn is_as_safe_as(&self, other: &PoolTier) -> bool;
}

impl PoolTierExt for PoolTier {
    fn is_as_safe_as(&self, other: &PoolTier) -> bool {
        // Pool Tier A safest
        self <= other
    }
