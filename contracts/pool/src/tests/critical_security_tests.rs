    ...
    fn test_rebalance_reentrancy_protection() {
        ...
        e.as_contract(&contract_address, || {
            ...
            let rebalance = || {
                ...
                let delta = get_delta_a(&e, 1_0000000, 1_0000000);
...
mod access_control_tests {
    ...
    fn test_emergency_pause_authorization() {
        ...
        e.as_contract(&contract_address, || {
            ...
            let emergency_pause = |caller: &Address| -> Result<(), &str> {
    ...
    fn test_role_transfer_security() {
        ...
        e.as_contract(&contract_address, || {
            ...
            let propose_new_admin = |caller: &Address, proposed: Address| -> Result<(), &str> {
                if caller != &admin {
            ...
            let accept_admin_role = |caller: &Address| -> Result<(), &str> {
                match &pending_admin {
