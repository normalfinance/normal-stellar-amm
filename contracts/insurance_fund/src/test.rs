...
// use normal_rust_types::types::{Stake, StakeAction};
...
//     assert_eq!(
//         setup.insurance_fund.get_stake(&users[1]),
//         Stake {
...
//     setup
//         .insurance_fund
//         .deposit(&users[1], &amount_to_deposit_2);
...
//     setup
//         .insurance_fund
//         .deposit(&users[2], &amount_to_deposit_2);
...
//     // Insurance Fund issued shares
//     assert_eq!(
//         setup.insurance_fund.get_total_shares(),
...
//     setup
//         .insurance_fund
//         .request_withdraw(&users[1], &amount_to_deposit);
...
//     setup
//         .insurance_fund
//         .request_withdraw(&users[1], &amount_to_withdraw);
...
//     setup
//         .insurance_fund
//         .request_withdraw(&users[1], &(amount_to_deposit + 10_0000000_u128));
// }
...
//     setup
//         .insurance_fund
//         .request_withdraw(&staker, &amount_to_deposit);
//     let unstaking_period = setup.insurance_fund.get_unstaking_period();
//     jump(&setup.env, unstaking_period + ONE_HOUR);
...
//     assert_eq!(
//         insurance_fund
//             .try_request_withdraw(&user1, &desired_amount)
//             .unwrap_err(),
