...
// use normal_rust_types::types::InsuranceClaim;
// use normal_rust_types::testutils::Setup;
...
//     // Collect pre-deposit values

//     // let pool_reserves = setup.router.get_reserves(tokens, &setup.pool_index);
//     // let pool_info = setup.router.get_info(tokens, pool_index);

//     // Register XLM oracle
//     // setup.oracle_registry.register_oracle(&setup.admin, &setup.btc_asset_id, &setup.oracle, &14, &0);

//     // // Register BTC oralce
//     // setup.oracle_registry.register_oracle(&setup.admin, &setup.xlm_asset_id, &setup.oracle, &14, &0);
...
//     assert_eq!(reserves.get(0).unwrap(), 10);
