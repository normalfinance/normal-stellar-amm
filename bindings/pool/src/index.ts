...
export interface Client {
   ...
   */
  initialize: ({config}: {config: PoolConfig}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a get_insurance_claim transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_insurance_claim: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<InsuranceClaim>>
   ...
   */
  rebalance: ({admin, action}: {admin: string, action: NormalAction}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  delist: ({admin}: {admin: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_mint_cap_fraction: ({admin, mint_cap_fraction}: {admin: string, mint_cap_fraction: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAOaW5pdGlhbGl6ZV9hbGwAAAAAAAEAAAAAAAAABnBhcmFtcwAAAAAH0AAAABNJbml0aWFsaXplQWxsUGFyYW1zAAAAAAA=",
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAQAAAAAAAAAGY29uZmlnAAAAAAfQAAAAClBvb2xDb25maWcAAAAAAAA=",
        "AAAAAAAAAAAAAAAHZGVwb3NpdAAAAAADAAAAAAAAAAR1c2VyAAAAEwAAAAAAAAAOZGVzaXJlZF9hbW91bnQAAAAAAAoAAAAAAAAACm1pbl9zaGFyZXMAAAAAAAoAAAABAAAD7QAAAAMAAAAKAAAACgAAAAs=",
        ...
        "AAAAAAAAAAAAAAAId2l0aGRyYXcAAAADAAAAAAAAAAR1c2VyAAAAEwAAAAAAAAAMc2hhcmVfYW1vdW50AAAACgAAAAAAAAALbWluX2Ftb3VudHMAAAAD6gAAAAoAAAABAAAD7QAAAAIAAAAKAAAACw==",
        ...
        "AAAAAAAAAAAAAAATZ2V0X2luc3VyYW5jZV9jbGFpbQAAAAAAAAAAAQAAB9AAAAAOSW5zdXJhbmNlQ2xhaW0AAA==",
        ...
        "AAAAAAAAAAAAAAAJcmViYWxhbmNlAAAAAAAAAgAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAZhY3Rpb24AAAAAB9AAAAAMTm9ybWFsQWN0aW9uAAAAAQAAAAs=",
        ...
        "AAAAAAAAAAAAAAASc2V0X21heF9pbWJhbGFuY2VzAAAAAAADAAAAAAAAAAVhZG1pbgAAAAAAABMAAAAAAAAAF2xpcXVpZGl0eV9tYXhfaW1iYWxhbmNlAAAAAAoAAAAAAAAADW1heF9pbnN1cmFuY2UAAAAAAAAKAAAAAA==",
  ...
  public readonly fromJSON = {
    initialize_all: this.txFromJSON<null>,
        ...
        get_insurance_claim: this.txFromJSON<InsuranceClaim>,
