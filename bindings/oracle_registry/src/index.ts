...
export interface Client {
   ...
   */
  register_oracle: ({admin, asset, oracle_addr, decimals, sanitize_clamp_denominator}: {admin: string, asset: string, oracle_addr: string, decimals: u32, sanitize_clamp_denominator: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  delete_oracle: ({admin, asset}: {admin: string, asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
